...
class UserAdmin(UserAdmin):
    model = User
    list_display = ('username', 'email', 'first_name', 'last_name', 'is_active', 'is_staff', 'is_admin', 'is_superuser', 'last_login',)
    search_fields = ('username', 'email','first_name', 'last_name',)
    ordering = ('first_name', 'last_name', 'email',)
    # filter_horizontal = ('groups', 'user_permissions',)

    fieldsets = (
        ('User Info', {'fields': ('username', 'email', 'first_name', 'last_name', 'is_active', 'is_staff', 'is_admin', 'is_superuser', 'last_login',)}),
